       ...
       <div className='bg-white rounded-lg px-8 py-6 drop-shadow-sm'>
         ...
         <div className='flex flex-col sm:grid grid-cols-2 gap-8'>
            ...
            <div>
              ...
              <img className='rounded-md' src={image ? URL.createObjectURL(image) : ''} alt="" />
            </div>
            ...
            <div className='flex flex-col'>
              ...
              <img src={resultImage ? resultImage : ""} alt="" />
              {
                ...
                {/* -----------------Buttons --------------- */}
              {  resultImage && <div className='flex justify-center sm:justify-end items-centerflex flex-wrap gap-4 mt-6'>
